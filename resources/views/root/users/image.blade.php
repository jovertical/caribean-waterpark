        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Select image for <em>{{ $user->name }}</em></h3>
                </div>
            </div>
        </div>
        <!--/. Head-->
        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <form method="POST" action="{{ route('root.users.image.upload', $user) }}" class="m-dropzone dropzone"
                        id="form-user-upload">
                            {{ csrf_field() }}
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route('root.users.index') }}" class="btn btn-brand">Finish</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formUserUpload = {
            paramName: 'image',
            addRemoveLinks : true,
            maxFiles: 1,
            maxFilesize: 6,
            ...
            init: function() {
                ...
                $myDropzone.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('root.users.image.destroy', $user) }}',
                        headers: {
                ...
                $.get('{{ route('root.users.image.uploaded', $user) }}', function(data) {
