<tr>
    ...
    <td>
        <span class="d-flex">
            ...
            <form method="GET" action="{{ route('root.categories.edit', $category->id) }}" class="form-edit">
                {{ method_field('PUT') }}
            ...
            <form method="POST" action="{{ route('root.categories.destroy', $category->id) }}" class="form-delete">
                {{ method_field('DELETE') }}
                {{ csrf_field() }}
