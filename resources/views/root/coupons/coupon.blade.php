        ...
        <span class="d-flex" style="overflow: visible;">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="javascript:void(0);" data-form="#toggleCoupon" data-action="{{ route('root.coupon.toggle', 
                    ...
                    <a href="{{ route('root.coupon.image', $coupon) }}" class="dropdown-item">
                        <i class="la la-image"></i> Image
                    </a>
                </div>
            </div>

            <a href="javascript:void(0);" data-form="#editCoupon" data-action="{{ route('root.coupon.edit', $coupon) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill edit-coupon" title="Edit coupon"><i class="la la-edit"></i>
            </a>

            <a href="javascript:void(0);" data-form="#destroyCoupon" data-action="{{ route('root.coupon.destroy', 
