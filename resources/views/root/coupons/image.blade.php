        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Select image for <em>{{ $coupons->name }}</em></h3>
                </div>
            </div>
        </div>
        <!--/. Head-->
        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <form method="POST" action="{{ route('root.coupons.image.upload', $coupons) }}" class="m-dropzone dropzone"
                        id="form-coupon-upload">
                            {{ csrf_field() }}
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route('root.coupons.index') }}" class="btn btn-brand">Finish</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formCouponUpload = {
            paramName: 'image',
            addRemoveLinks : true,
            maxFiles: 1,
            maxFilesize: 6,
            ...
            init: function() {
                ...
                $myDropzone.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('root.coupons.image.destroy', $coupons) }}',
                        headers: {
                ...
                $.get('{{ route('root.coupons.image.uploaded', $coupons) }}', function(data) {
